...
namespace TB.WEBAPI.TMCS.APPLICATION.DTOs.Requests.Motors
{
    public class MotorSubmitRequest
    {
        ...
        public string? InsIDCard { get; set; }

        [JsonPropertyName("INS_BIRTHDATE")]
        [Description("วันเกิดผู้เอาประกัน")]
        public string? InsBirthDate { get; set; }
        ...
        public int CoverMoneyCost { get; set; }

        [JsonPropertyName("COV_CARDAMAGE")]
        public int CoverCarDamage { get; set; }

        [JsonPropertyName("COV_CARLOSS")]
        public int CoverCarLoss { get; set; }

        [JsonPropertyName("COV_FLOODAMT")]
        public int CoverFloodAmount { get; set; }

        [JsonPropertyName("VOL_NET_PREMIUM_AMT")]
        public int VMINetPremiumAmount { get; set; }

        [JsonPropertyName("VOL_TOTAL_PREMIUM_AMT")]
        public double VMITotalPremiumAmount { get; set; }

        [JsonPropertyName("COP_NET_PREMIUM_AMT")]
        public double CMINetPremiumAmount { get; set; }

        [JsonPropertyName("COP_TOTAL_PREMIUM_AMT")]
        public double CMITotalPremiumAmount { get; set; }
        ...
        public string? SubInsureTypeVMI { get; set; }

        [JsonPropertyName("SUBINS_TYPE_CMI")]
        public string? SubInsureTypeCMI { get; set; }
