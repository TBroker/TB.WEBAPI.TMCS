...
{
    public class IssuePolicyComResponse
    {
        [JsonPropertyName("status")]
        public string? Status { get; set; }

        [JsonPropertyName("objresponse")]
        public ObjResponseCom? ObjResponse { get; set; }
        ...
        public PayloadCom? Payload { get; set; }
    }

    public class MotorDataCom
    {
    ...
    public class PayloadCom
    {
        [JsonPropertyName("motordata")]
        public MotorDataCom? MotorData { get; set; }
    }
}
