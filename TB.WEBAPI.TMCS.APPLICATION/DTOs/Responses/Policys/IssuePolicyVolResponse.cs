...
{
    public class IssuePolicyVolResponse
    {
        [JsonPropertyName("status")]
        public string? Status { get; set; }

        [JsonPropertyName("objresponse")]
        public ObjResponseVol? ObjResponse { get; set; }

        [JsonPropertyName("volpolicyno")]
        public string? VolPolicyNo { get; set; }
        ...
        public PayloadVol? Payload { get; set; }
    }

    public class MotorDataVol
    {
    ...
    public class PayloadVol
    {
        [JsonPropertyName("motordata")]
        public MotorDataVol? MotorData { get; set; }
    }
}
