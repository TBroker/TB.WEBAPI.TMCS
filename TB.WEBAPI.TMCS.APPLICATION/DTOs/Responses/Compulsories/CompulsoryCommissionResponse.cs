...
namespace TB.WEBAPI.TMCS.APPLICATION.DTOs.Responses.Compulsories
{
    public class CompulsoryCommissionResponse
    {
        ...
        public double CommRateAgent { get; set; }

        [JsonPropertyName("COMM_AMTE_AGENT")]
        public double CommAmountAgent { get; set; }
